...
#include "third_party/blink/renderer/core/html/html_element_random.h"
...
int HTMLElement::offsetHeightForBinding() {
  ...
  if (const auto* layout_object = GetLayoutBoxModelObject()) {
    // add
    int OffsetHeight = layout_object->OffsetHeight().ToInt() + get_random_offsetHeight();
    result = AdjustForAbsoluteZoom::AdjustLayoutUnit(
                 (LayoutUnit)OffsetHeight, layout_object->StyleRef())
                 .Round();
